...
/*	for (int i = 1; i < argc; i++)
	...
	hedcut.debug=debug = true;
	sample_size = 3;
	hedcut.uniform_disk_size = false;
	hedcut.disk_size = 3;
	hedcut.cvt_iteration_limit = 1;
	hedcut.max_site_displacement = 8;
	hedcut.black_disk = true;
	hedcut.average_termination = true;
	hedcut.gpu = false;
	hedcut.subpixels = 1.3;
	...
	cv::Mat image = cv::imread("phoenix.png");
